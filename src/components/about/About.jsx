    ...
    <div id="about" className="abt-main-cont">
      ...
      <div className="abt-rgt-side-cont">
        ...
        <div className="abt-rgt-side-tp-header">
          Hello Learners, I am Vyshali Vijaywargi from Kothagudem district. An optimistic and
        ...
        <div className="abt-rgt-side-bottom-header">
          ...
          I faced some really challenging times, but I was always interested to
          be a problem solver and because of this attitude I came to know about
          the tech industries and how they work.
          After scrolling to many skill-building websites and watching tons of
          tutorial videos I was feeling directionless but joining functionUp
